      ...
      <div className={`${BRAND.spacing.pageMaxWidth} mx-auto px-4 ${BRAND.spacing.sectionPadding}`}>
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-text-muted">Save your contact details to connect with professionals.</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                <input
                  ...
                  className="mt-1 h-4 w-4 text-primary border-text/20 rounded focus:ring-primary"
                />
                <label htmlFor="adult" className="text-sm text-text cursor-pointer">
              ...
              <div className="flex items-start gap-3">
                <input
                  ...
                  className="mt-1 h-4 w-4 text-primary border-text/20 rounded focus:ring-primary"
                />
                <label htmlFor="contact" className="text-sm text-text cursor-pointer">
                  I consent to be contacted by a professional through this demonstration workspace.
                </label>
              </div>

              <button
                type="submit"
                disabled={submitting || !isAdultConfirmed}

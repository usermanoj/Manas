  ...
  return (
    <main className="min-h-screen bg-background">
      <div className={`${BRAND.spacing.pageMaxWidth} mx-auto px-4 ${BRAND.spacing.sectionPadding}`}>
        <h1 className={`${BRAND.typography.headingSize} font-semibold text-text`}>Professionals</h1>
        <p className="mt-2 text-text-muted">Browse mock professional profiles for potential handoff. Coming soon.</p>
